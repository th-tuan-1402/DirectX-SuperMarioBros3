...
protected:
	...
	Point centerPosition; // Giữ tọa độ ban đầu làm tọa độ tâm. Muốn mai rùa rung lắc khi rúc đầu lên
...
public:
	...
	virtual void SetHoldablePosition(Point pos);
	virtual void Release(bool isFromHigher);
	virtual Point GetHoldableCollisionBox();
